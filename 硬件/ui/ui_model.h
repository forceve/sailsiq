...
typedef enum {
    ...
    UI_CMD_SET_CLOCK_MODE,          /* value: ui_clock_mode_t */
    UI_CMD_SET_CLOCK_DATE,          /* value: yyyymmdd */
    UI_CMD_SET_CLOCK_MINUTES,       /* value: minutes since midnight */
    UI_CMD_SYNC_CLOCK_GPS,
} ui_command_t;
